...
urlpatterns = [
    ...
    path('devis/detail/<int:pk>', views.DevisDetailView, name='devis-detail'),
    ...
    path('dealer/detail/<int:pk>', views.SaleToDealerDetails, name='sale-dealer-detail'),
    ...
    path('refund/dealer/detail/<int:pk>', views.RefundDealerDetails, name='refund-dealer-payment'),
