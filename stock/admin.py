...
class TheItemAdmin(ItemAdmin):  # Inherit from ItemAdmin
    list_display = ('id','date','item', 'description', 'initial_quantity','alert_qte','price','category','packaging','ref',
                    'weight','qte_inStock')
...
class ParfumItemAdmin(ItemAdmin):  # Inherit from ItemAdmin
    list_display = ('id', 'item', 'description', 'price', 'sub_brand','initial_quantity','alert_qte','qte_inStock')
